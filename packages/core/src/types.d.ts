...
export type InstallState = "installed_active" | "installed_dormant" | "not_installed" | "forbidden_for_scoring";
export type SourceFamily = "market_structure" | "onchain_flow" | "rank_aggregator" | "social_sentiment" | "risk_annotation";
export type EvidenceCategory = "discovery" | "confirmation" | "risk" | "veto";
export type EvidenceDirection = "bullish" | "bearish" | "neutral" | "risk";
...
export type LifecycleStage = "onchain_early" | "cex_transition" | "cex_liquid" | "late_speculative";
export type RegimeState = "trend_expansion" | "trend_mature" | "range_chop" | "blowoff_exhaustion" | "range_distribution" | "data_degraded";
export type RouterMode = "trend_long" | "exhaustion_short";
export type RouterDecision = "observe" | "observe_soft" | "observe_cooloff_15m" | "watchlist" | "range_distribution_watch" | "trend_long_candidate" | "short_candidate" | "veto";
